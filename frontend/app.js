...
function setStatus(message, isError = false) {
  ...
  outputPanel.className = isError ? "output output--error" : "output output--success";
}
...
if (!window.require) {
  setOutput("Monaco loader failed to load. Check your network connection and refresh.");
